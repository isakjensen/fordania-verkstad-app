...
CREATE TABLE "organization" (
    ...
    "metadata" TEXT,
    "city" TEXT,
    "plan" TEXT NOT NULL DEFAULT 'Bas',
...
-- CreateIndex
CREATE INDEX "mechanic_organizationId_idx" ON "mechanic"("organizationId");
...
-- AddForeignKey
ALTER TABLE "mechanic" ADD CONSTRAINT "mechanic_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
