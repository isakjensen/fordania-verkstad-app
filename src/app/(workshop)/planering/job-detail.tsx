      ...
      <SheetContent className="w-full sm:max-w-md" showCloseButton={false}>
        {job ? (
          <>
            ...
            <div className="sticky bottom-0 z-10 mt-auto border-t border-line bg-surface/95 px-5 pt-3 pb-[max(0.75rem,calc(env(safe-area-inset-bottom)-0.5rem))] backdrop-blur-sm">
