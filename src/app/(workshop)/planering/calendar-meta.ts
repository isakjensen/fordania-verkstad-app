...
export const typeMeta: Record<string, TypeMeta> = {
  ...
  Besiktning: {
    ...
    ring: "ring-violet-200/50 dark:ring-violet-500/15",
  ...
  Däckbyte: {
    ...
    ring: "ring-teal-200/50 dark:ring-teal-500/15",
  ...
  Rekond: {
    ...
    ring: "ring-emerald-200/50 dark:ring-emerald-500/15",
  ...
  Felsökning: {
    ...
    ring: "ring-rose-200/50 dark:ring-rose-500/15",
